...
interface RestDetailsRouteParams {
  id: number;
}
...
export default function RestDetails() {
  ...
  const params = route.params as RestDetailsRouteParams;
  ...
  function handleOpenGoogleMapRoutes() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${rest?.latitude},${rest?.longitude}`)
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>{rest.about}</Text>
        ...
        <Text style={styles.description}>{rest.instructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {rest.hours}</Text>
          </View>
